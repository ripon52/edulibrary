...
@section('content')
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Update {{ $department->name }} Profile</a></li>
        </ol>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        {{ Form::model($department,['route'=>['department.update',$department->id],'method'=>"post"]) }}
                        @include('department.form-department',["button"=>"Update Department"])
                        {{ Form::close() }}
                    </div>
                </div>
            </div>
